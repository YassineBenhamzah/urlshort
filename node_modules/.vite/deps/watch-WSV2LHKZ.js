import {
  ...
  picomatchExports,
  rollupInternal
} from "./chunk-GKRI656W.js";
import {
  require_events,
  require_node_os,
  require_stream,
  require_util
} from "./chunk-FY7V26NX.js";
import {
  require_node_crypto,
  require_node_events,
  ...
  require_promises,
  require_tty
} from "./chunk-ATU44VD6.js";
import {
  require_os
} from "./chunk-G4CYKWGN.js";
import {
  require_node_path
} from "./chunk-LWIRSAIA.js";
import {
  require_fs
} from "./chunk-L3X6U223.js";
import {
  require_path
} from "./chunk-45K6YQQ3.js";
import {
  __esm,
  __toESM
} from "./chunk-GXWCFSR6.js";
...
var import_node_path, import_node_process, import_node_os, import_fs, import_util, import_stream, import_path, import_os, import_events, import_node_perf_hooks, import_node_crypto, import_promises, import_node_events, import_tty, chokidar, fs$3, Readable, sysPath$3, promisify$3, picomatch$1, readdir$1, stat$3, lstat$2, realpath$1, BANG$2, RECURSIVE_ERROR_CODE, NORMAL_FLOW_ERRORS, FILE_TYPE, DIR_TYPE, FILE_DIR_TYPE, EVERYTHING_TYPE, ALL_TYPES, isNormalFlowError, maj, min, wantBigintFsStats, normalizeFilter, ReaddirpStream, readdirp$1, readdirpPromise, readdirp_1, anymatchExports, anymatch$2, normalizePath$2, picomatch, normalizePath$1, BANG$1, DEFAULT_OPTIONS, arrify$1, createPattern, matchPatterns, anymatch$1, isExtglob$1, isExtglob2, chars, strictCheck, relaxedCheck, isGlob$2, isGlob$1, pathPosixDirname, isWin32, slash, backslash, enclosure, globby, escaped, globParent$1, utils$3, utils$2, stringify$4, isNumber$2, isNumber$1, toRegexRange$1, toRegexRange_1, util, toRegexRange, isObject, transform, isValidValue, isNumber, zeros, stringify$3, pad, toMaxLen, toSequence, toRange, toRegex, rangeError, invalidRange, invalidStep, fillNumbers, fillLetters, fill$2, fillRange, fill$1, utils$1, compile$1, compile_1, fill, stringify$2, utils, append, expand$1, expand_1, constants$1, stringify$1, MAX_LENGTH, CHAR_BACKSLASH, CHAR_BACKTICK, CHAR_COMMA, CHAR_DOT, CHAR_LEFT_PARENTHESES, CHAR_RIGHT_PARENTHESES, CHAR_LEFT_CURLY_BRACE, CHAR_RIGHT_CURLY_BRACE, CHAR_LEFT_SQUARE_BRACKET, CHAR_RIGHT_SQUARE_BRACKET, CHAR_DOUBLE_QUOTE, CHAR_SINGLE_QUOTE, CHAR_NO_BREAK_SPACE, CHAR_ZERO_WIDTH_NOBREAK_SPACE, parse$1, parse_1, stringify, compile, expand, parse, braces$1, braces_1, binaryExtensionsExports, binaryExtensions$1, require$$0, path, binaryExtensions, extensions, isBinaryPath$1, constants, fs$2, sysPath$2, promisify$2, isBinaryPath, isWindows$1, isLinux, EMPTY_FN$2, EMPTY_STR$1, KEY_LISTENERS, KEY_ERR, KEY_RAW, HANDLER_KEYS, EV_CHANGE$2, EV_ADD$2, EV_ADD_DIR$2, EV_ERROR$2, STR_DATA$1, STR_END$2, BRACE_START$1, STAR, THROTTLE_MODE_WATCH, open, stat$2, lstat$1, close, fsrealpath, statMethods$1, foreach, addAndConvert, clearItem, delFromSet, isEmptySet, FsWatchInstances, fsWatchBroadcast, setFsWatchListener, FsWatchFileInstances, setFsWatchFileListener, NodeFsHandler$1, nodefsHandler, fseventsHandlerExports, fseventsHandler, require$$3, fs$1, sysPath$1, promisify$1, fsevents, EV_ADD$1, EV_CHANGE$1, EV_ADD_DIR$1, EV_UNLINK$1, EV_ERROR$1, STR_DATA, STR_END$1, FSEVENT_CREATED, FSEVENT_MODIFIED, FSEVENT_DELETED, FSEVENT_MOVED, FSEVENT_UNKNOWN, FSEVENT_TYPE_FILE, FSEVENT_TYPE_DIRECTORY, FSEVENT_TYPE_SYMLINK, ROOT_GLOBSTAR, DIR_SUFFIX, DOT_SLASH, FUNCTION_TYPE$1, EMPTY_FN$1, IDENTITY_FN, Depth, stat$1, lstat, realpath, statMethods, FSEventsWatchers, consolidateThreshhold, wrongEventFlags, createFSEventsInstance, couldConsolidate, canUse, calcDepth, sameTypes, FsEventsHandler$1, EventEmitter, fs, sysPath, promisify, readdirp, anymatch, globParent2, isGlob2, braces, normalizePath, NodeFsHandler2, FsEventsHandler2, EV_ALL, EV_READY, EV_ADD, EV_CHANGE, EV_UNLINK, EV_ADD_DIR, EV_UNLINK_DIR, EV_RAW, EV_ERROR, STR_CLOSE, STR_END, BACK_SLASH_RE, DOUBLE_SLASH_RE, SLASH_OR_BACK_SLASH_RE, DOT_RE, REPLACER_RE, SLASH, SLASH_SLASH, BRACE_START, BANG, ONE_DOT, TWO_DOTS, GLOBSTAR, SLASH_GLOBSTAR, ANYMATCH_OPTS, STRING_TYPE, FUNCTION_TYPE, EMPTY_STR, EMPTY_FN, isWindows, isMacos, isIBMi, stat, readdir, arrify, flatten, unifyPaths, toUnix, normalizePathToUnix, normalizeIgnored, getAbsolutePath, undef, DirEntry, STAT_METHOD_F, STAT_METHOD_L, WatchHelper, FSWatcher, watch, FileWatcher, eventsRewrites, Watcher, Task;
var init_watch = __esm({
  "node_modules/rollup/dist/es/shared/watch.js"() {
    ...
    sysPath$3 = import_path.default;
    ({ promisify: promisify$3 } = import_util.default);
    picomatch$1 = picomatchExports;
    readdir$1 = promisify$3(fs$3.readdir);
    stat$3 = promisify$3(fs$3.stat);
    lstat$2 = promisify$3(fs$3.lstat);
    realpath$1 = promisify$3(fs$3.realpath);
    BANG$2 = "!";
    ...
    normalizePath$2 = function(path2, stripTrailing) {
    ...
    anymatch$1 = (matchers, testString, options = DEFAULT_OPTIONS) => {
      if (matchers == null) {
    ...
    isGlob$2 = function isGlob(str, options) {
      if (typeof str !== "string" || str === "") {
        return false;
      }
      if (isExtglob2(str)) {
    ...
    isGlob$1 = isGlob$2;
    pathPosixDirname = import_path.default.posix.dirname;
    ...
    toRegexRange$1 = (min2, max, options) => {
    ...
    isBinaryPath$1 = (filePath) => extensions.has(path.extname(filePath).slice(1).toLowerCase());
    constants = {};
    (function(exports) {
    ...
    open = promisify$2(fs$2.open);
    stat$2 = promisify$2(fs$2.stat);
    lstat$1 = promisify$2(fs$2.lstat);
    close = promisify$2(fs$2.close);
    fsrealpath = promisify$2(fs$2.realpath);
    ...
    setFsWatchFileListener = (path2, fullPath, options, handlers) => {
    ...
    require$$3 = getAugmentedNamespace(fseventsImporter);
    fs$1 = import_fs.default;
    sysPath$1 = import_path.default;
    ...
    Depth = (value) => isNaN(value) ? {} : { depth: value };
    stat$1 = promisify$1(fs$1.stat);
    lstat = promisify$1(fs$1.lstat);
    realpath = promisify$1(fs$1.realpath);
    ...
    createFSEventsInstance = (path2, callback) => {
      const stop = fsevents.watch(path2, callback);
      return { stop };
    };
    couldConsolidate = (path2) => {
      let count = 0;
    ...
    normalizePathToUnix = (path2) => toUnix(sysPath.normalize(toUnix(path2)));
    normalizeIgnored = (cwd = EMPTY_STR) => (path2) => {
...
rollup/dist/es/shared/watch.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=watch-WSV2LHKZ.js.map
