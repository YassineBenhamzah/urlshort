...
// node_modules/vite/dist/node/chunks/dep-98d07f71.js
...
var import_node_url, import_node_path, import_node_module, __filename, __dirname, require2, UNDEFINED_CODE_POINTS, REPLACEMENT_CHARACTER, CODE_POINTS, SEQUENCES, ERR, DEFAULT_BUFFER_WATERLINE, Preprocessor, TokenType, token, htmlDecodeTree, CharCodes, BinTrieFlags, NS, ATTRS, DOCUMENT_MODE, TAG_NAMES, TAG_ID, TAG_NAME_TO_ID, $, SPECIAL_ELEMENTS, UNESCAPED_TEXT, html, C1_CONTROLS_REFERENCE_REPLACEMENTS, State, TokenizerMode, Tokenizer, IMPLICIT_END_TAG_REQUIRED, IMPLICIT_END_TAG_REQUIRED_THOROUGHLY, SCOPING_ELEMENT_NS, NAMED_HEADERS, TABLE_ROW_CONTEXT, TABLE_BODY_CONTEXT, TABLE_CONTEXT, TABLE_CELLS, OpenElementStack, NOAH_ARK_CAPACITY, EntryType, MARKER, FormattingElementList, defaultTreeAdapter, VALID_DOCTYPE_NAME, VALID_SYSTEM_ID, QUIRKS_MODE_SYSTEM_ID, QUIRKS_MODE_PUBLIC_ID_PREFIXES, QUIRKS_MODE_NO_SYSTEM_ID_PUBLIC_ID_PREFIXES, QUIRKS_MODE_PUBLIC_IDS, LIMITED_QUIRKS_PUBLIC_ID_PREFIXES, LIMITED_QUIRKS_WITH_SYSTEM_ID_PUBLIC_ID_PREFIXES, MIME_TYPES, DEFINITION_URL_ATTR, ADJUSTED_DEFINITION_URL_ATTR, SVG_ATTRS_ADJUSTMENT_MAP, XML_ATTRS_ADJUSTMENT_MAP, SVG_TAG_NAMES_ADJUSTMENT_MAP, EXITS_FOREIGN_CONTENT, foreignContent, HIDDEN_INPUT_TYPE, AA_OUTER_LOOP_ITER, AA_INNER_LOOP_ITER, InsertionMode, BASE_LOC, TABLE_STRUCTURE_TAGS, defaultParserOptions, Parser, TABLE_VOID_ELEMENTS, escapeAttribute, escapeText, VOID_ELEMENTS, defaultOpts;
var init_dep_98d07f71 = __esm({
  "node_modules/vite/dist/node/chunks/dep-98d07f71.js"() {
...
//# sourceMappingURL=dep-98d07f71-SF35RI5L.js.map
